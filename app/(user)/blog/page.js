  ...
  return (
    <div className="blog-list-container">
      ...
      <div className="blog-cards">
        {books.map((book) => (
          <Link key={book.id} href={`/blog/${book.id}`} className="blog-card-link">
            <div className="blog-card">
              ...
              <p className="blog1-title"><strong>Title:</strong> {book.title}</p>
              <p className="blog-author"><strong>Author:</strong> {book.author}</p>
              <p className="blog-rating"><strong>Rating:</strong> {book.rating}</p>
